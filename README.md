...
DIKX engine's core fragment shader (`shaders/glsl/main.fp`) was reduced to plain rendering math. This mod ships its **own** `shaders/glsl/main.fp` that overrides the engine's copy (last-loaded lump wins) and carries all of the glow / neon / visual-regime code.
